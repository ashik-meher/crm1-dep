...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'j!)r#wdx%^9uy=kg11-4b^i=2d2zwyps8nw2o25bsdm!8et0u#'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['inventory-lite.herokuapp.com']
...
ROOT_URLCONF = 'inventoryLite.urls'
...
WSGI_APPLICATION = 'inventoryLite.wsgi.application'
